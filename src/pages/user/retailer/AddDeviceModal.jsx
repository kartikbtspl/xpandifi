...
//     if (initialData) {
//       dispatch(updateDevice({ id: initialData.id, data: payload })).then(
//         (res) => {
//           if (!res.error) {
//             reset();
//             onClose();
...
//                   initialData
//                     ? deviceOptions.find(
//                         (opt) => opt.value === initialData.deviceId
//                       )
//                     : null
//                 }
//                 onChange={(option) => setValue("deviceId", option.value)}
...
//               Enter same <b>Name</b> and <b>Postcode</b> for Region if your city doesn't have one
//             </p>
//             <div>
...
//                 disabled={!isRegionEnabled}
//               />
//               {errors.regionPostcode && (
//                 <p className="text-red-500 text-sm">Postcode is required</p>
//               )}
//             </div>
