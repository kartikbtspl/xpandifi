    ...
    <>
      <div className="w-full">
        ...
        <ReusableTable
          ...
          order="desc"
          orderBy="updatedAt"
          searchableColumns={["name", "country", "state", "city", "regions"]}
        />
            ...
            {selected.status === "PENDING" && (
              <div className="flex gap-3 mt-8 justify-end">
                <button
                  ...
                  className="px-4 py-2 cursor-pointer rounded-md bg-red-100 hover:bg-red-200 text-red-700 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={formLoading}
                  className="px-5 py-2 rounded-md bg-green-100 text-green-600 hover:bg-green-200 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                >
